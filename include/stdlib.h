...
_ACRTIMP WLIBC_NORETURN void __cdecl exit(int code);
_ACRTIMP WLIBC_NORETURN void __cdecl _exit(int code);
_ACRTIMP WLIBC_NORETURN void __cdecl _Exit(int code);
_ACRTIMP WLIBC_NORETURN void __cdecl quick_exit(int code);
_ACRTIMP WLIBC_NORETURN void __cdecl abort(void);
